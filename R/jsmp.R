...
#'
#' @param dat Juvenile salmon data with 6 columns.
#' @param jsmp Juvenile salmon monitoring program.
#' @import tidyverse DBI shiny dbplyr shinythemes DT shinycssloaders readxl
#' @return shiny app of salmon runs. Type 'jsmp(RBsalmon)' to launch shiny app
#'
#' @name jsmp
#'
#'
