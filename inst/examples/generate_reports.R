...
#' @return Generate automated pdf reports for individual years and fish runs. Can also sum multiple runs for a single year. See jsmp.R to sum multiple years for a single fish run.
